...
import { fetchCandidateById } from '@/api/CandidateApi';
...
const CandidateView = () => {
    ...
    const [candidateList, setCandidateList] = useState<CandidateInterface>({} as CandidateInterface)

    const handleFetchById = async () => {
        const data = await fetchCandidateById(Number(candidateId))
